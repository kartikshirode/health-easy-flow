      ...
      <section className="bg-gradient-to-b from-health-light to-white dark:from-health-dark dark:to-background py-16 md:py-24">
        <div className="health-container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            >
              <motion.div variants={fadeIn} custom={0} className="flex items-center space-x-2 mb-2">
                <div className="badge">PhD, MD</div>
                <div className="badge">Board Certified</div>
                <div className="badge">15+ Years</div>
              </motion.div>
              <motion.h1 variants={fadeIn} custom={1} className="text-4xl md:text-5xl font-bold text-health-dark dark:text-white leading-tight">
                Advanced Medical Care by a Leading Specialist
              </motion.h1>
              <motion.p variants={fadeIn} custom={2} className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-xl">
      ...
      <section className="py-12 bg-white dark:bg-gray-900">
        <div className="health-container">
          <motion.div 
            ...
            variants={staggerContainer}
          >
            <motion.div variants={fadeIn} custom={0} className="flex items-center bg-health-light dark:bg-gray-800 px-6 py-3 rounded-full">
            ...
            <motion.div variants={fadeIn} custom={1} className="flex items-center bg-health-light dark:bg-gray-800 px-6 py-3 rounded-full">
            ...
            <motion.div variants={fadeIn} custom={2} className="flex items-center bg-health-light dark:bg-gray-800 px-6 py-3 rounded-full">
            ...
            <motion.div variants={fadeIn} custom={3} className="flex items-center bg-health-light dark:bg-gray-800 px-6 py-3 rounded-full">
      ...
      <section className="py-16 bg-gray-50 dark:bg-background">
        <div className="health-container">
          ...
          >
            {[
              {
                icon: <Stethoscope className="h-8 w-8 text-health-primary" />,
                title: "Advanced Diagnostics",
                description: "Utilizing state-of-the-art technology for precise diagnoses based on the latest research findings."
              },
              {
                icon: <BookOpen className="h-8 w-8 text-health-primary" />,
                title: "Research-Backed Care",
                description: "Treatment protocols derived from peer-reviewed studies and the latest medical research advancements."
              },
              {
                icon: <Globe className="h-8 w-8 text-health-primary" />,
                title: "Global Perspective",
                description: "International training and collaboration with leading medical institutions worldwide."
              },
              {
                icon: <Award className="h-8 w-8 text-health-primary" />,
                title: "Academic Excellence",
                description: "Bringing rigorous academic standards to everyday clinical practice with evidence-based approaches."
              }
            ].map((benefit, index) => (
              <motion.div
                key={index}
              ...
              >
                <Card className="border-none shadow-md hover:shadow-lg transition-shadow dark:bg-gray-800 card-hover rounded-2xl overflow-hidden h-full">
                  <CardContent className="pt-6">
                    <div className="flex flex-col items-center text-center space-y-4">
                      <div className="p-3 bg-health-light dark:bg-health-primary/20 rounded-full">
                        {benefit.icon}
                      </div>
                      <h3 className="font-semibold text-xl dark:text-white">{benefit.title}</h3>
